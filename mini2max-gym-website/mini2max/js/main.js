...
const GALLERY = [
  { src: "images/hero.jpg",        category: "gym",         label: "The Gym" },
  ...
  { src: "images/gym-land-3.jpg",  category: "gym",         label: "The Gym" },
  { src: "images/gym-land-4.jpg",  category: "gym",         label: "The Gym" },
  { src: "images/gym-wide-1.jpg",  category: "strength",    label: "Strength" },
  { src: "images/gym-land-5.jpg",  category: "strength",    label: "Strength" },
  { src: "images/gym-land-6.jpg",  category: "strength",    label: "Strength" },
  { src: "images/gym-land-7.jpg",  category: "strength",    label: "Strength" },
  { src: "images/gym-land-8.jpg",  category: "strength",    label: "Strength" },
  { src: "images/gym-port-1.jpg",  category: "strength",    label: "Strength" },
  { src: "images/gym-wide-2.jpg",  category: "cardio",      label: "Cardio" },
  { src: "images/gym-port-2.jpg",  category: "cardio",      label: "Cardio" },
  { src: "images/gym-port-3.jpg",  category: "cardio",      label: "Cardio" },
  { src: "images/gym-port-4.jpg",  category: "cardio",      label: "Cardio" },
  ...
  { src: "images/gym-port-7.jpg",  category: "functional",  label: "Functional" },
  { src: "images/gym-port-8.jpg",  category: "functional",  label: "Functional" }
];
...
function initParallax() {
  ...
  window.addEventListener(
    ...
    () => {
      targets.forEach((t) => {
        const speed = parseFloat(t.dataset.parallax || "0.2");
        const r = t.getBoundingClientRect();
        if (r.bottom < 0 || r.top > window.innerHeight) return;
        t.style.transform = `translateY(${r.top * speed * -0.25}px)`;
      });
    },
    { passive: true }
  );
